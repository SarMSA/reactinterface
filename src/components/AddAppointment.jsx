    ...
    className={`bg-blue-400 text-white px-2 py-3 w-full text-left ${toggleForm?'rounded-t-md': 'rounded-md'}`}>
        ...
        {toggleForm &&
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
                ...
                className="border-solid border-2 p-2 max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
            </div>
            </div>
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
                <input 
                onChange={(event)=> {setFormData({...formData, aptData: event.target.value})}}
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
                ...
                className="border-solid border-2 p-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Detailed comments about the condition"></textarea>
            </div>
            </div>
